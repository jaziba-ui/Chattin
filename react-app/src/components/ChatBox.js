        ...
        {this.props.targetUser ? (
          <div>
            <NavbarComponent
              left={
                <div>
                  ...
                  <Avatar
                    src={require(`../static/images/avatar/${this.props.targetUser.id}.png`)}
                    alt={"logo"}
                    size="large"
            ...
            <MessageList
              ...
              toBottomHeight={"100%"}
              dataSource={
                this.props.targetUser?.messages?.map((msg) => ({
                  ...msg,
                  position: msg.position || "left", // fallback if somehow undefined
